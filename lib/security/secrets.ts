...
export const SECRET_NAME_PATTERN =
  /^(?:REAPI_API_KEY|FAL_KEY|FAL_WEBHOOK_SECRET|TOPAZ_API_KEY|OPENAI_API_KEY|PAYSTACK_SECRET_KEY|PAYFAST_MERCHANT_KEY|PAYFAST_PASSPHRASE|PAYONEER_TOKEN|BETTER_AUTH_SECRET|GOOGLE_CLIENT_SECRET|RESEND_API_KEY|INTERNAL_SERVICE_SECRET|R2_SECRET_ACCESS_KEY|R2_ACCESS_KEY_ID)$/;

export const FORBIDDEN_PUBLIC_ENV =
  /^NEXT_PUBLIC_(?:.*(?:SECRET|PRIVATE)|.*API_KEY|FAL_KEY|REAPI_API_KEY|PAYSTACK_SECRET|PAYFAST_MERCHANT_KEY|PAYFAST_PASSPHRASE|PAYONEER_TOKEN)/i;
