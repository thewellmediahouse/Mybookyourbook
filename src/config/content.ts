...
export const contentConfig = {
  ...
  about: {
    ...
    intro: {
      ...
      paragraph:
        'We combine business strategy, premium media production, website development, content systems, tourism marketing, accommodation marketing, event planning support, and growth consulting into one integrated partnership.',
    },
    cta: {
