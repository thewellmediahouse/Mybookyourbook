  ...
  const body = (
    <>
      ...
      <div className="relative mt-auto p-5 sm:p-6">
        ...
        <h3 className="mt-1 text-lg font-semibold tracking-tight text-foreground sm:text-xl">{title}</h3>
        {subtitle ? <p className="mt-1.5 max-w-md text-sm leading-6 text-muted">{subtitle}</p> : null}
